...
Notes:
- The script assumes ../Final.csv is available in the parent directory.
- It writes plots to ../outputs/ and models to ../models/.
- Uses curated feature list from ../models/selected_features_v2.csv if available.
"""
...
try:
    ...
    print(f"❌ Error: {DATA_CSV} not found. Please ensure ../Final.csv is in the parent directory.")
    exit(1)
...
print('\n🔧 FEATURE SELECTION...')
try:
    features_df = pd.read_csv('../models/selected_features_v2.csv')
