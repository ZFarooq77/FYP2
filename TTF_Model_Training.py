...
print("✅ Correlation analysis saved to ttf_model_outputs/correlation_analysis.csv")
...
print("✅ VIF analysis saved to ttf_model_outputs/vif_analysis.csv")
...
print("✅ Feature importances saved to ttf_model_outputs/ttf_feature_importances.csv")
...
models['Stacking_Ensemble'] = stacking_model
...
print("✅ Model performance summary saved to ttf_model_outputs/model_performance_summary.csv")
...
best_model_path = os.path.join(OUTPUT_DIR, f'best_ttf_model_{best_model_name.lower()}.pkl')
scaler_path = os.path.join(OUTPUT_DIR, 'ttf_feature_scaler.pkl')
features_path = os.path.join(OUTPUT_DIR, 'ttf_selected_features.csv')
...
print("✅ All visualizations saved to ttf_model_outputs/")
